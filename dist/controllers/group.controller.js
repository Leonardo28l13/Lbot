...
export class GroupController {
    ...
    // Função para o comando !calar e !descalar
    setMutedParticipant(groupId, userId, operation) {
        return this.groupService.setMutedParticipant(groupId, userId, operation);
    }

    // Função para os comandos !removeranking e !addranking
    setParticipantRankingVisibility(groupId, userId, isHidden) {
        return this.participantService.setParticipantRankingVisibility(groupId, userId, isHidden);
    }
