...
*|*► *${prefix}calar* - calar usuário
*|*► *${prefix}descalar* - usuário pode falar normalmente
*|*► *${prefix}rmranking* - remove o usuário do ranking
*|*► *${prefix}addranking* - adiciona o usuário no ranking
