...
const groupCommands = {
    ...
    calar: {
        guide: `Ex: *{$p}calar* @membro - Impede o membro de falar no grupo (bot apaga a mensagem).\n\n` +
            `Ex: Responder com *{$p}calar* - Impede o membro respondido de falar.\n`,
        msgs: {
            reply: "🤫 @{$1} foi calado e não pode mais enviar mensagens no grupo.",
            error_cant_mute_admin: "Não é possível calar um administrador ou o bot."
        },
        function: groupFunctions.calarCommand
    },
    descalar: {
        guide: `Ex: *{$p}descalar* @membro - Permite que o membro volte a falar no grupo.\n\n` +
            `Ex: Responder com *{$p}descalar* - Permite que o membro respondido volte a falar.\n`,
        msgs: {
            reply: "🗣️ @{$1} foi descalado e já pode falar no grupo novamente.",
        },
        function: groupFunctions.descalarCommand
    },
    promover: {
    ...
    apg: {
        ...
        topativos: {
        guide: `Ex: *{$p}topativos* - Exibe o ranking de atividade de todos os membros do grupo.\n`,
        msgs: {
            reply_title: "🏆 *Ranking de Atividade - {$1} Membros*\n\n",
            reply_item: "{$1} *{$2}° Lugar* @{$3} - {$4} msgs\n"
        },
        function: groupFunctions.topativosCommand
    },
    removeranking: {
        guide: `Ex: *{$p}removeranking* @membro - Oculta o membro do ranking de atividade.\n\n` +
            `Ex: Responder com *{$p}removeranking* - Oculta o membro respondido do ranking.\n`,
        msgs: {
            reply: "🙈 O membro @{$1} foi ocultado do ranking de atividade.",
            error_cant_hide_admin: "Não é possível ocultar um administrador ou o bot do ranking."
        },
        function: groupFunctions.removerankingCommand
    },
    addranking: {
        guide: `Ex: *{$p}addranking* @membro - Mostra novamente o membro no ranking de atividade.\n\n` +
            `Ex: Responder com *{$p}addranking* - Mostra novamente o membro respondido no ranking.\n`,
        msgs: {
            reply: "👀 O membro @{$1} agora será exibido novamente no ranking de atividade.",
        },
        function: groupFunctions.addrankingCommand
    },
    membro: {
    ...
    evento: {
        guide: `Ex: *{$p}evento* - Fecha o grupo apenas para admins e envia uma enquete de participação.\n`,
        msgs: {
            // As mensagens de sucesso/erro já são enviadas pela própria função.
        },
        function: groupFunctions.eventoCommand
    }
};
