...
const miscCommands = {
    ...
    ia: {
        guide: `Ex: *{$p}ia* Qual a capital do Brasil? - Responde perguntas utilizando Inteligência Artificial.\n`,
        msgs: {
            wait: "🧠 Pensando...",
            reply: "🤖 *Resposta da IA*\n\n{$1}",
            error_no_question: "Você precisa me fazer uma pergunta! Ex: *{$p}ia* Qual o sentido da vida?",
        },
        function: miscFunctions.iaCommand
    }
};
